...
function FashionPage({ isDarkMode }) {
    ...
    return (
        <div className={`fashion item container ${isDarkMode ? 'dark-mode ' : 'light-mode text-black'}`}>
            <h2 className={`mb-5 lg:mb-8 text-3xl lg:text-4xl text-center font-bold ${isDarkMode ? 'dark-mode text-white' : 'light-mode'}`}>패션</h2>
