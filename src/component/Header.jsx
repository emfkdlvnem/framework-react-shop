                    ...
                    <ul>
                        ...
                        <li>
                            <div>
                                ...
                                <span className="absolute top-1 left-0 px-2.5 py-1 rounded-full bg-red-500 text-xs font-bold leading-none text-gray-200 transform translate-x-1/2 -translate-y-1/2">
                                    {cartCount}
                                </span>
                            </div>
                        </li>
